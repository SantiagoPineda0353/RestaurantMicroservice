...
public class SecurityConfig {
    ...
    private static final String ROL3="EMPLEADO";
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        http
                ...
                .authorizeRequests()
                    ...
                    .antMatchers(HttpMethod.GET , "/api/v1/orders/").hasRole(ROL3)
                    ...
                    .antMatchers(HttpMethod.PATCH , "/api/v1/orders/*/cancel").hasRole(ROL4)
                    .antMatchers(HttpMethod.GET , "/api/v1/orders/efficiency/**").hasRole(ROL2)
